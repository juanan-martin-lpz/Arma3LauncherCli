...
namespace DownloadManager
{
    ...
    {
        public event Delegates.DownloadProgressChange OnDownloadProgressChange;
        public event Delegates.DownloadCompleted OnDownloadCompleted;
        public event Delegates.DownloadStarted OnDownloadStarted;
        public event Delegates.DownloadPaused OnDownloadPaused;
        public event Delegates.DownloadResumed OnDonwloadResumed;
        public event Delegates.DownloadCancelled OnDownloadCancelled;
        public event Delegates.DownloadError OnDownloadError;
        ...
        DownloadInfo info;
        Task<Tuple<long, byte[]>> DownloadTask;
        bool paused;

        // Interfaz para el Manager
        public void Start()
        {

            AsyncCompletedEventArgs args = new AsyncCompletedEventArgs(null, false, info);
            OnDownloadStarted(this, args);

            paused = false;

            DownloadTask = GetByteArrayAsyncWithProgress(info.URL, this);
        ...
        public HttpDownloader(DownloadInfo downloadInfo)
        {
            ...
            try
            {
                ...
                info.Size = (int)bytesTotal;

            }
            catch (System.Net.WebException ex)
            {
                AsyncCompletedEventArgs args = new AsyncCompletedEventArgs(ex, true, info);

                OnDownloadError(this, args);
